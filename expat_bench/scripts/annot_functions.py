...
# def annotate_fragment(df):
#     # Does the sequence have the word fragment in the header. (?i) forces it to be lowercase
#     # df.loc[df['Info'].str.contains('(?i)fragment'), 'Fragment_Status'] = True


#     df['Fragment'] = df['Info'].str.contains('(?i)fragment')
...
def get_aligned_positions(entry, sequence, *positions):
    ...
    # print ('aligned positions')
    # print (aligned_positions)
    # print ("".join([sequence[bp] for bp in aligned_positions]))
