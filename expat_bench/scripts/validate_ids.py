...
for chunk_df in list_df:
    ...
    for db_id in chunk_df["Try"].unique():
        ...
        chunk_df = chunk_df.merge(
            add_df,
            how="left",
            on=["Entry", "Info", "Truncated_Info", "Sequence", "Original_FASTA", "Try"],
        )
    ...
    # Now lets map them to EMBL GenBank IDs as well
